...
option(UUIDXX_USE_MSVC_PARALLEL_BUILD "If enabled, build multiple files in parallel." ON)
option(UUIDXX_USE_MSVC_STATIC_ANALYSIS "If enabled, run MSVC built-in static analysis and generate appropriate warnings" ON)
option(UUIDXX_USE_WIN32_LEAN_AND_MEAN "If enabled, define WIN32_LEAN_AND_MEAN" ON)

if(UUIDXX_NOT_SUBPROJECT)
  message(STATUS "uuidxx compiler MSVC global conf is in active")
...
function(uuidxx_apply_common_compile_options TARGET)
  target_compile_definitions(${TARGET}
    PUBLIC
      ...
      $<$<BOOL:UUIDXX_USE_WIN32_LEAN_AND_MEAN>:WIN32_LEAN_AND_MEAN>
  )
...
function(uuidxx_apply_msvc_parallel_build TARGET)
  message(STATUS "Apply uuidxx msvc parallel build for ${TARGET}")
...
# uuidxx_apply_msvc_static_analysis(foobar
#   WDL
#     /wd6011
# )
function(uuidxx_apply_msvc_static_analysis TARGET)
  message(STATUS "Apply uuidxx msvc static analysis for ${TARGET}")
